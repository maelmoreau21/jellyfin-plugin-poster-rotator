...
public sealed class PosterRotatorLocalization : IPosterRotatorLocalization
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Resources = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Help.Libraries"] = "Choose which libraries Poster Rotator will process for poster downloads and rotations. If none or all are checked, all libraries are processed.",
            ["Help.ConfigureLibrariesTip"] = "To configure which libraries Poster Rotator automatically processes in the background, visit",
            ["Button.SelectAll"] = "Select all",
            ["Button.DeselectAll"] = "Deselect all",
            ["Label.SelectedLibrariesCount"] = "{0} of {1} libraries selected",
            ...
            ["Label.PoolSize"] = "Pool size (posters per item)",
            ["Help.PoolSize"] = "Number of posters to collect and rotate for each item (default: 4, min: 1, max: 50).",
            ["Label.MinHoursBetweenSwitches"] = "Minimum delay between rotations (hours)",
            ["Help.MinHoursBetweenSwitches"] = "Cooldown before a poster can rotate again (default: 72 hours / 3 days. 0 = allow rotation at each run).",
            ...
            ["Label.MaxDownloadsPerRun"] = "Maximum poster downloads per run",
            ["Help.MaxDownloadsPerRun"] = "(0 = no limit. Limits downloads per execution to prevent API rate limiting.)",
            ["Label.SortBy"] = "Sort by",
            ["Option.SortUpdated"] = "Date updated",
            ["Option.SortName"] = "Alphabetical (A-Z)",
            ["Option.SortImages"] = "Poster count",
            ["Option.SortLastRotated"] = "Last rotation",
            ["Label.SortOrder"] = "Order",
            ["Option.SortDesc"] = "Descending",
            ["Option.SortAsc"] = "Ascending",
            ["Label.StatusFilter"] = "Status",
            ["Option.AllStatuses"] = "All pools",
            ["Option.IncompletePools"] = "Incomplete (< Target)",
            ["Option.CompletePools"] = "Complete pools",
            ["Label.LockFilter"] = "Lock",
            ["Option.AllLocks"] = "All",
            ["Option.LockedOnly"] = "Locked only",
            ["Option.UnlockedOnly"] = "Unlocked only",
            ["Label.DownloadProgress"] = "Downloading posters in progress",
            ["Status.DownloadProgress"] = "{0}% ({1} processed, {2} images added — Current: {3})",
            ["Heading.MediaTypes"] = "Target media types",
            ["Help.MediaTypes"] = "Choose which media kinds will have poster pools and rotations.",
            ["Checkbox.MoviePosters"] = "Movies",
            ["Checkbox.SeriesPosters"] = "Series",
            ["Checkbox.BoxSetPosters"] = "Collections / Sagas",
            ["Heading.ImageQuality"] = "Image Quality & Downloads",
            ...
            ["Help.PoolStorage"] = "PluginData (recommended) stores posters centrally and enables browsing and managing pools in this web dashboard. Media folders stores posters in .poster_pool next to video files (not displayed in the web dashboard list).",
            ...
            ["Button.RotateAllLibraries"] = "Rotate all libraries",
            ["Button.PurgeAllPools"] = "Delete all pools",
            ["Button.PurgeLibrary"] = "Purge library",
            ["Button.PurgeItem"] = "Purge media",
            ["Button.DeleteCurrentPool"] = "Delete this pool",
            ["Message.ConfirmDeleteCurrentPool"] = "Delete the poster pool for this item?",
            ["Message.RotateAllLibrariesConfirm"] = "Rotate posters across all libraries now?",
            ...
            ["Message.Refreshed"] = "Pools list and statistics refreshed.",
        ...
        ["fr"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Help.Libraries"] = "Choisissez les bibliotheques que Poster Rotator doit traiter pour les telechargements et rotations d'affiches. Si aucune ou toutes sont cochees, toutes les bibliotheques sont traitees.",
            ["Help.ConfigureLibrariesTip"] = "Pour configurer les bibliotheques traitees automatiquement en arriere-plan par Poster Rotator, rendez-vous dans",
            ["Button.SelectAll"] = "Tout selectionner",
            ["Button.DeselectAll"] = "Tout deselectionner",
            ["Label.SelectedLibrariesCount"] = "{0} sur {1} bibliotheque(s) selectionnee(s)",
            ...
            ["Label.PoolSize"] = "Taille du pool (affiches par média)",
            ["Help.PoolSize"] = "Nombre d'affiches à collecter et faire tourner pour chaque média (défaut : 4, min : 1, max : 50).",
            ["Label.MinHoursBetweenSwitches"] = "Délai minimum entre rotations (heures)",
            ["Help.MinHoursBetweenSwitches"] = "Délai avant qu'une affiche puisse re-tourner (défaut : 72h / 3 jours. 0 = rotation autorisée à chaque passage).",
            ...
            ["Label.MaxDownloadsPerRun"] = "Nombre maximal d'affiches telechargees par passage",
            ["Help.MaxDownloadsPerRun"] = "(0 = illimite. Limite le nombre de telechargements par passage pour eviter le blocage API.)",
            ["Label.SortBy"] = "Trier par",
            ["Option.SortUpdated"] = "Date de modification",
            ["Option.SortName"] = "Alphabetique (A-Z)",
            ["Option.SortImages"] = "Nombre d'affiches",
            ["Option.SortLastRotated"] = "Derniere rotation",
            ["Label.SortOrder"] = "Ordre",
            ["Option.SortDesc"] = "Decroissant",
            ["Option.SortAsc"] = "Croissant",
            ["Label.StatusFilter"] = "Statut",
            ["Option.AllStatuses"] = "Tous les pools",
            ["Option.IncompletePools"] = "Incomplets (< Cible)",
            ["Option.CompletePools"] = "Pools complets",
            ["Label.LockFilter"] = "Verrouillage",
            ["Option.AllLocks"] = "Tous",
            ["Option.LockedOnly"] = "Verrouilles uniquement",
            ["Option.UnlockedOnly"] = "Non verrouilles",
            ["Label.DownloadProgress"] = "Telechargement des affiches en cours",
            ["Status.DownloadProgress"] = "{0}% ({1} traites, {2} affiches ajoutees — En cours : {3})",
            ["Heading.MediaTypes"] = "Types de medias cibles",
            ["Help.MediaTypes"] = "Choisissez les types de medias qui auront des pools d'affiches et des rotations.",
            ["Checkbox.MoviePosters"] = "Films",
            ["Checkbox.SeriesPosters"] = "Series",
            ["Checkbox.BoxSetPosters"] = "Collections / Sagas",
            ["Heading.ImageQuality"] = "Qualite d'image et telechargement",
            ...
            ["Help.PoolStorage"] = "PluginData (recommande) stocke les affiches de maniere centralisee et permet leur affichage et gestion dans l'interface. Dossiers medias stocke les affiches dans .poster_pool a cote des videos (non affiche dans la liste web).",
            ...
            ["Button.RotateAllLibraries"] = "Rotation de toutes les bibliothèques",
            ["Button.PurgeAllPools"] = "Supprimer tous les pools",
            ["Button.PurgeLibrary"] = "Purger bibliotheque",
            ["Button.PurgeItem"] = "Purger media",
            ["Button.DeleteCurrentPool"] = "Supprimer ce pool",
            ["Message.ConfirmDeleteCurrentPool"] = "Supprimer le pool d'affiches de ce média ?",
            ["Message.RotateAllLibrariesConfirm"] = "Lancer la rotation des affiches pour toutes les bibliothèques maintenant ?",
            ...
            ["Message.Refreshed"] = "Liste des pools et statistiques actualisees.",
