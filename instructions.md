...
Prepare Poster Rotator `1.8.2.0` for Jellyfin `12.0.0.0`.
...
- Keep `1.7.0.0`, `1.8.0.0`, and `1.8.1.0` as the previous Jellyfin 12 lines.
...
1. Verify that `Version`, `AssemblyVersion`, and `FileVersion` are `1.8.2.0`.
2. Compile in `Release` against the authenticated Jellyfin 12 package.
3. Run tests.
4. Create `Jellyfin.Plugin.PosterRotator-1.8.2.0.zip` containing:
...
6. Keep the `1.8.1.0`, `1.8.0.0`, `1.7.0.0`, and `1.6.0.0` manifest entries for previous lines.
