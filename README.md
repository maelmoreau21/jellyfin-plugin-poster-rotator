...
- Plugin version: `1.8.5.1`
- Target ABI: Jellyfin `12.0.0.0`
- Jellyfin packages: `12.0.0` (stable)
- Runtime: `.NET 10`

Version `1.8.5.1` does not make raw SQL access. It uses Jellyfin services (`ILibraryManager`, `IProviderManager`) and stores its state in the plugin's data folder.
